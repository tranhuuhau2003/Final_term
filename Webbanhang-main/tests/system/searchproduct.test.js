...
describe('renderProducts', () => {
    ...
    test('Should call detailProduct with correct ID when clicking on a product link', () => {
        const sampleProducts = [
            { id: 1, img: 'img1.jpg', title: 'Product 1', price: 10000 }
        ];
        ...
        const productLink = document.querySelector('.card-image-link');
        productLink.click();

        expect(global.detailProduct).toHaveBeenCalledWith(1);
    });

    test('Should call detailProduct with correct ID when clicking on a product button', () => {
        const sampleProducts = [
            { id: 1, img: 'img1.jpg', title: 'Product 1', price: 10000 }
        ];
        ...
        const productButton = document.querySelector('.card-button');
        productButton.click();
